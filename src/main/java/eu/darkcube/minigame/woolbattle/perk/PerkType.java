...
public enum PerkType implements Comparable<PerkType> {
	...
	WOOL_BOMB(Item.PERK_WOOL_BOMB, Item.PERK_WOOL_BOMB_COOLDOWN, 10, PerkName.WOOL_BOMB, false, 8),
	...
	WALL_GENERATOR(Item.PERK_WALL_GENERATOR, Item.PERK_WALL_GENERATOR_COOLDOWN, 10, PerkName.WALL_GENERATOR, false, 1,
			true),
	...
	MINIGUN(Item.PERK_MINIGUN, Item.PERK_MINIGUN_COOLDOWN, 10, PerkName.MINIGUN, false, 2),

	GRABBER(Item.PERK_GRABBER, Item.PERK_GRABBER_COOLDOWN, 7, PerkName.GRABBER, false, 10),

	BOOSTER(Item.PERK_BOOSTER, Item.PERK_BOOSTER_COOLDOWN, 20, PerkName.BOOSTER, false, 12),
