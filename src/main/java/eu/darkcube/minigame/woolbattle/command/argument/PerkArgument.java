...
public class PerkArgument implements ArgumentType<PerkTypeSelector> {
	...
	private final Predicate<PerkType> filter;
	...
	private PerkArgument(Supplier<PerkType[]> teams, Predicate<PerkType> filter,
					...
					Function<String, PerkType> fromStringFunction,
					boolean single) {
		this.single = single;
	...
	public static Collection<PerkType> getPerkTypes(
	...
	@Override
	public PerkTypeSelector parse(StringReader reader)
